...
import 'package:barterlt/views/screens/shared/loginscreen.dart';
import 'package:barterlt/views/screens/shared/registerationscreen.dart';
...
class _ProfileTabScreenState extends State<ProfileTabScreen> {
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                          ...
                          return CachedNetworkImage(
                            imageUrl:
                                "${MyConfig().SERVER}/barterlt/assets/profile/${widget.user.id}.png?v=$val",
                            placeholder: (context, url) =>
                                const LinearProgressIndicator(),
                            errorWidget: (context, url, error) {
                              return Image.network(
                                "${MyConfig().SERVER}/barterlt/assets/profileicon.png",
                                scale: 2,
                              );
                            },
                          );
  ...
  Future<bool> checkImageExists() async {
    try {
      final response = await http.head(
        Uri.parse(
            "${MyConfig().SERVER}/barterit/assets/profile/${widget.user.id}.png?v=$val"),
      );
