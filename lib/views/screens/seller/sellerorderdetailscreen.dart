...
// import 'package:barterlt/models/itemdetails.dart';
...
//                               fit: BoxFit.cover,
//                               imageUrl:
//                                   "${MyConfig().SERVER}/barterlt/assets/catches/${orderdetailsList[index].catchId}.png",
...
//     http.post(
//         Uri.parse(
//             "${MyConfig().SERVER}/barterlt/php/load_sellerorderdetails.php"),
//         body: {
...
//   void loadbuyer() {
//     http.post(Uri.parse("${MyConfig().SERVER}/barterlt/php/load_user.php"),
//         body: {
